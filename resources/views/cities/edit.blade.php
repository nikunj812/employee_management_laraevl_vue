            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        {{ __('Edit City') }}
                        <a href="{{route('cities.index')}}" class="btn btn-primary mb-2 float-right">Back</button></a>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('cities.update', $city->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="state_id" type="text" class="form-control"  name="state_id" aria-label="Default select example">
